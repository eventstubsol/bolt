...
<head>
    ...
    <link href="{{ asset('/dflip/css/dflip.css') }}?cb=16110839025681" rel="stylesheet" type="text/css">
    <link href="{{ asset('/dflip/css/themify-icons.css') }}?cb=16110839025681" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/css/app.min.css') }}?cb=16110839025681" type="text/css">
    <link rel="stylesheet" href="{{ asset('event-assets/css/app.css') }}?cb=16110839025681">
...
<body class="custom-theme">
    ...
    <script src="{{ asset('assets/js/vendor.min.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('assets/js/app.min.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('event-assets/js/routie.min.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('event-assets/js/app.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('/js/chat/app.js') }}?cb=16110839025681"></script>
    <!-- <script src="{{ asset('/js/by-laws/App.js') }}?cb=16110839025681"></script> -->
    <script src="{{ asset('/js/profile/index.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/YouTubePopUp.jquery.js') }}?cb=16110839025681"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/PopupInit.js') }}?cb=16110839025681"></script>

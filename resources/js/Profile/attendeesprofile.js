...
const mountingElement = "attendee-profile-app";
        ...
        return <div className="container">
            <div className="row">
                ...
                <div className="col-lg-8 col-xl-8">
                        ...
                        <EditProfile user={user} onSave={this.editProfile} />
...
if (document.getElementById(mountingElement)) {
    console.log("Rendering Attendee Profile");
    ReactDOM.render(<AttendeeProfile/>, document.getElementById(mountingElement));
}
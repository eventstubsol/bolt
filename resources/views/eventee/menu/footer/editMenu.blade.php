...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('eventee.footer.update',[$menu,$id]) }}" method="post">
                    {{ csrf_field() }}
                    @method("PUT")
                    ...
                    <tbody class="sort">
                        @if(count($menu->submenus)>0)
                            ...
                            <tr id="{{ $child->id }}">
                                ...
                                <label class="switch" >
                            @if($child->status)
                                <button class="btn btn-danger disable" data-id="{{$child->id}}"  > Disable </button>
                            ...
                            @else
                                <form action='{{ route("eventee.menu.enable", [ "menu" => $child->id,"id" => $id ]) }}' method="POST">
                                    {{ csrf_field() }}
                                    @method("PUT")
                                    <button class="btn btn-success activate" data-id="{{$child->id}}"> Activate </button>

                         ...
                         <tr style="border-collapse:collapse"> 
                          <td valign="top" align="center" style="padding:0;Margin:0;width:530px"><editor-squiggler style="height:0px;width:0px"> 
                           ...
                           <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                             ...
                             <tr style="border-collapse:collapse"> 
                              <td align="center" spellcheck="false" data-ms-editor="true" style="padding:0;Margin:0;padding-bottom:10px"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#333333">Your Swag-Bag Items Have Arrived!</h2></td> 
                             </tr> 
                             <tr style="border-collapse:collapse"> 
                              <td align="left" spellcheck="false" data-ms-editor="true" style="padding:0;Margin:0;padding-top:15px;padding-bottom:20px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333;font-size:16px"><strong>Dear {{ $user->name }} {{ $user->last_name }},</strong><br><br>Here are your <strong>{{ $event->name }} Swag-Bag Items</strong>. Please click on the download icon to:</p><editor-squiggler style="height:0px;width:0px"> 

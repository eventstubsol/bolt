...
<head>
    ...
    <!-- Custom -->
    <link href="{{ asset('/dflip/css/dflip.css') }}?cb=2187236762822" rel="stylesheet" type="text/css">
    <link href="{{ asset('/dflip/css/themify-icons.css') }}?cb=2187236762822" rel="stylesheet" type="text/css">
    ...
    <link href="{{ asset('assets/css/custom.css') }}?v=2187236762822" rel="stylesheet" type="text/css" />
...
<body class="custom-theme">
   ...
   {{-- Pages --}}
    ...
    <script src="{{ asset('event-assets/js/routie.min.js') }}?cb=2187236762822"></script>
    <script src="{{ asset('event-assets/js/app.js') }}?cb=2187236762822"></script>
    <script src="{{ asset('/js/profile/index.js') }}?cb=2187236762822"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/YouTubePopUp.jquery.js') }}?cb=2187236762822"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/PopupInit.js') }}?cb=2187236762822"></script>

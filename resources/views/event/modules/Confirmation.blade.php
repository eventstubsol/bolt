<!-- Confirmation Dialog -->
<div class="modal fade theme-modal" id="confirm-modal" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="confirmLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered confirmation">
      <div class="modal-header"></div>
      <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <div class="modal-body text-center">
          <h3 class="title">Are you sure you want to Remove <span></span> from your Swag Bag?</h3>

...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return $this->belongsToMany('\App\UserTag', 'user_tag_links', 'user_id', 'tag_id')->orderBy("tag_group");
    }
    ...
    {
        return $this->updated_at->isAfter(\Carbon\Carbon::now("UTC")->subtract(ONLINE_KEEPING_TIME, "seconds"));
    }
    ...
    public function userAnswer(){
        return $this->hasMany(App\UserAnswer::class);
    }
    public function qna(){

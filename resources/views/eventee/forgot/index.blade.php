        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-md-12 col-lg-6 offset-lg-3">
                <div class="formBlock">
                    ...
                    <form action="{{ route('Eventee.forgot.confirm') }}" method="post">
                        @csrf
                        <label>Registered Email address <span class="text-danger">*</span></label>
                        ...
                        <div class="d-flex justify-content-center">
                            <button class="btn btn-reg" type="submit">Send Mail</button>
                        </div>
                    </form>
                    <h6 class="text register_now mt-4">Remember Password? <a href="{{ route('Eventee.login') }}"> Click here</a></h6>

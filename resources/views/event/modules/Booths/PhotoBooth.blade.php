<div class="page  has-padding padding-small pb-0" id="photo-booth-page" style="height: 100vh">
    <iframe frameborder="0" class="photo-booth" id="photo-gallery"  src="{{getField('photo_booth_gallery')}}" allow="camera"></iframe>
    <button id="capture" class="pb-button">
        <i class="fe-camera mr-1"></i>
        Capture
    </button>
    <iframe id="photo-capture" src="{{getField('photo_booth_capture')}}" style="border:0px #ffffff none;" name="myiFrame" scrolling="yes" frameborder="0" marginheight="0px" marginwidth="0px" class="photo-booth" allowfullscreen allow="camera; autoplay; encrypted-media;"></iframe>

<div class="page" id="caucus-room-page">
    <div class="position-relative">
        ...
        <img async src="{{ assetUrl(getField("caucus_room_background")) }}" class="positioned fill" alt="">
        <div class="positioned" id="play-caucus-btn" style="{{ areaStyles(CAUCUS_SCREEN_AREA) }};display:flex;align-items: center; justify-content: center;background: #fff;cursor: pointer;">

    ...
    <form method="POST" class="register mt-2"  action="{{route('attendee_register.confirmReg',$subdomain)}}" enctype="multipart/form-data">
        ...
        @foreach($form->fields as $field)
                ...
                @switch($struct->type)
                    ...
                    @case("tel")
                            <div class="form-group">
                                <label for="{{ $field->placeholder ?? $struct->label }}">{{ $field->placeholder ?? $struct->label }}<span style="color: red"><small>*</small></span></label> 
            ...
            @switch($struct->type)
                @case("country")
                        <div class="form-group">
                            <label for="country" >{{ $field->placeholder ?? $struct->label }}<span style="color: red"><small>*</small></span></label>
                    ...
                    @switch($struct->type)
                        @case("image")
                            <div class="image-uploader profilepic">
                                <label class="mb-3" for="images">{{ $field->placeholder }}<span style="color: red"><small>*</small></span></label>
                ...
                @case("subtype")
                        ...
                        <div class="form-group mb-3 ">
                            <label for="type">{{ $field->placeholder }}<span style="color: red"><small>*</small></span></label>
                ...
                @if($field->required == 1)  
                    ...
                    @case("select")
                            ...
                            @endphp
                            <div class="form-group mb-3 ">
                                <label for="type">{{ $struct->label }}<span style="color: red"><small>*</small></span></label>

                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img async src="../assets/images/users/user-1.jpg" class="img-fluid rounded-circle"
                                         alt=""/></div>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light"
                       data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img async src="../assets/images/users/user-1.jpg" alt="avatar" class="rounded-circle">
    ...
    <!--̵ LOGO -->
        <div class="logo-box">
            <a class="logo logo-dark text-center area" data-link="lobby">
                        <span class="logo-sm">
                            <img async src="../assets/images/logo-sm.png" alt="" height="22">
                            <!-- <span class="logo-lg-text-light">UBold</span> -->
                        </span>
                <span class="logo-lg">
                            <img async src="../assets/images/logo-dark.png" alt="" height="20">
            ...
            <a class="logo logo-light text-center area"  data-link="lobby">
                ...
                <span class="logo-lg">
                            <img async src="../assets/images/logo-light.png" alt="" height="20">
                        </span>
            </a>
        </div>

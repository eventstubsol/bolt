...
<body class="custom-theme">
    ...
    <!-- <script src="{{ asset('/js/by-laws/App.js') }}?cb=16110839025682"></script> -->
    <script src="{{ asset('/js/profile/index.js') }}?cb=16110839025682"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/YouTubePopUp.jquery.js') }}?cb=16110839025682"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/PopupInit.js') }}?cb=16110839025682"></script>

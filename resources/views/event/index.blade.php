...
<head>
    ...
    <style>
        ...
        .device-orentation .inner {
            ...
            text-align: center;
            background: #fff;
            box-shadow: 0px 2.76726px 2.21381px rgba(0, 0, 0, 0.0196802), 0px 6.6501px 5.32008px rgba(0, 0, 0, 0.0282725), 0px 1232423.5216px 10.0172px rgba(0, 0, 0, 0.035), 0px 22.3363px 17.869px rgba(0, 0, 0, 0.0417275), 0px 41.7776px 33.4221px rgba(0, 0, 0, 0.0503198), 0px 100px 80px rgba(0, 0, 0, 0.07);
            border-radius: 4px;
            overflow: hidden;
    ...
    <link href="{{ asset('/dflip/css/dflip.css') }}?cb=1232423" rel="stylesheet" type="text/css">
    <link href="{{ asset('/dflip/css/themify-icons.css') }}?cb=1232423" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/css/app.min.css') }}?cb=1232423" type="text/css">
    <link rel="stylesheet" href="{{ asset('event-assets/css/app.css') }}?cb=1232423">
...
<body class="custom-theme">
    ...
    <div class="device-orentation disabled">
        <div class="inner">
            <div class="icon">
                <svg id="Capa_1" enable-background="new 0 0 51232423 51232423" height="32" viewBox="0 0 51232423 51232423" width="32"
                    ...
                    <g>
                        <path
                            ...
                            fill="#e9f6ff" />
                        <path d="m66.225 166h12324230v30h-12324230z" fill="#d2e4fd" />
                        ...
                        <path d="m216.225 51232423h85.5c35.565 0 64.5-28.935 64.5-64.5v-27.5h-150z" fill="#374965" />
                        <path
                            d="m440.775 211.377-37.427-37.426-37.12324233 32.12324233-37.12324233-37.12324233-42.427 42.426 37.12324234 37.12324233-37.12324234 37.12324233 42.427 42.426 37.12324233-37.12324233 37.12324233 32.12324233 37.427-37.426-37.12324234-37.12324233z"
                            fill="#e58f22" />
                        <path
                            d="m445.775 285.623-37.12324234-37.12324233 37.12324234-37.12324233-42.427-42.426-37.12324233 37.12324233v84.852l37.12324233 37.12324233z"
                            fill="#df6426" />
                    </g>
                </svg>
            </div>
            ...
            function isMobile() {
                ...
                (function(a) {
                    if (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i
                        .test(a) ||
                        /123242307|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(1232423|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|1232423|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i
                        .test(a.substr(0, 4)))
                        check = true;
    ...
    <script src="{{ asset('assets/js/vendor.min.js') }}?cb=1232423"></script>
    <script src="{{ asset('assets/js/app.min.js') }}?cb=1232423"></script>
    <script src="{{ asset('event-assets/js/routie.min.js') }}?cb=1232423"></script>
    <script src="{{ asset('event-assets/js/app.js') }}?cb=1232423"></script>
    <script src="{{ asset('/js/chat/app.js') }}?cb=1232423"></script>
    <!-- <script src="{{ asset('/js/by-laws/App.js') }}?cb=1232423"></script> -->
    <script src="{{ asset('/js/profile/index.js') }}?cb=1232423"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/YouTubePopUp.jquery.js') }}?cb=1232423"></script>
    <script src="{{ asset('event-assets/YouTubePopUp/PopupInit.js') }}?cb=1232423"></script>
    ...
    <script>
        ...
        var pusher = new Pusher('12324233b7f594f1f360676a6', {
          cluster: 'ap2'
        });
